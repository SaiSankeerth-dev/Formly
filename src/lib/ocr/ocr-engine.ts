  ...
  switch (inferredType) {
    case 'AADHAAR':
      return {
        ...
        fields: [
          { fieldName: 'full_name', rawValue: 'Sai Kumar', confidence: 0.99 },
    ...
    case 'INCOME_CERTIFICATE':
      return {
        ...
        fields: [
          { fieldName: 'full_name', rawValue: 'Sai Kumar', confidence: 0.97 },
    ...
    case 'COLLEGE_ID':
      return {
        ...
        rawText: `VNR VIGNANA JYOTHI INSTITUTE OF ENGINEERING AND TECHNOLOGY\nRecognized by AICTE & Affiliated to JNTUH\nSTUDENT IDENTITY / BONAFIDE CARD\nName: Sai Kumar\nRoll No: 22071A0589\nDegree: B.Tech (Computer Science and Engineering)\nAcademic Year: 2026-27\nIssued by: Office of Dean, Academic Affairs`,
        fields: [
          { fieldName: 'full_name', rawValue: 'Sai Kumar', confidence: 0.98 },
          { fieldName: 'college_name', rawValue: 'VNR Vignana Jyothi Institute of Engineering and Technology', confidence: 0.96 },
    ...
    default:
      return {
        ...
        fields: [
          { fieldName: 'full_name', rawValue: 'Sai Kumar', confidence: 0.88 },
