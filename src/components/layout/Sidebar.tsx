...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex md:w-64 bg-white border-r border-slate-100 flex-col justify-between h-screen sticky top-0 px-4 py-6 select-none z-30 shrink-0">
      <div>
        {/* Brand Logo & Tagline */}
...
export function MobileNavDrawer({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 w-72 max-w-[85vw] bg-white shadow-2xl z-[110] flex flex-col justify-between p-4 sm:p-5 transition-transform duration-300 ease-in-out md:hidden overflow-y-auto select-none",
      ...
      >
        <div>
          ...
          <div className="flex items-center justify-between pb-4 mb-4 border-b border-slate-100">
            ...
            >
              <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-indigo-600 via-indigo-500 to-blue-500 flex items-center justify-center shadow-md shadow-indigo-200">
            ...
            <button
              onClick={onClose}
              className="w-10 h-10 rounded-xl text-slate-500 hover:text-slate-800 hover:bg-slate-100 flex items-center justify-center transition-colors"
